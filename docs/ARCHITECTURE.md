...
interface Phase { kind: PhaseKind; seconds: number; }      // seconds can be 0 (skipped)
...
interface SafetyCaps { maxHoldSeconds: number; }            // default 8 for beginners

interface Progression {                                     // optional auto-ramp
